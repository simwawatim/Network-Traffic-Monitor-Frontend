...
const AttackPageComp = () => {
  ...
  useEffect(() => {
    const fetchAttackLogs = async () => {
      const mockLogs: AttackLog[] = [
        ...
        { uuid: "770e8400-e29b-41d4-a716-446655442002", timestamp: "2025-02-18 14:31:45", srcIp: "45.33.22.11", dstIp: "10.0.0.3", protocol: "UDP", packetSize: 65535, attackType: "ddos", severity: "critical" },
        { uuid: "770e8400-e29b-41d4-a716-446655442003", timestamp: "2025-02-18 14:38:22", srcIp: "94.102.61.88", dstIp: "10.0.0.8", protocol: "ICMP", packetSize: 1500, attackType: "scanning", severity: "high" },
        { uuid: "770e8400-e29b-41d4-a716-446655442004", timestamp: "2025-02-18 14:42:59", srcIp: "45.33.22.11", dstIp: "10.0.0.9", protocol: "TCP", packetSize: 65535, attackType: "ddos", severity: "critical" },
        { uuid: "770e8400-e29b-41d4-a716-446655442005", timestamp: "2025-02-18 14:50:14", srcIp: "185.130.5.253", dstIp: "10.0.0.5", protocol: "TCP", packetSize: 1024, attackType: "exploit", severity: "critical" },
        { uuid: "770e8400-e29b-41d4-a716-446655442006", timestamp: "2025-02-18 14:55:33", srcIp: "45.33.22.11", dstIp: "10.0.0.7", protocol: "UDP", packetSize: 65535, attackType: "ddos", severity: "critical" },
        { uuid: "770e8400-e29b-41d4-a716-446655442007", timestamp: "2025-02-18 15:03:47", srcIp: "94.102.61.88", dstIp: "10.0.0.1", protocol: "ICMP", packetSize: 64, attackType: "scanning", severity: "high" },
        { uuid: "770e8400-e29b-41d4-a716-446655442008", timestamp: "2025-02-18 15:12:21", srcIp: "185.130.5.253", dstIp: "10.0.0.4", protocol: "TCP", packetSize: 2048, attackType: "malicious", severity: "high" },
        { uuid: "770e8400-e29b-41d4-a716-446655442009", timestamp: "2025-02-18 15:18:05", srcIp: "45.33.22.11", dstIp: "10.0.0.11", protocol: "TCP", packetSize: 65535, attackType: "ddos", severity: "critical" },
        { uuid: "770e8400-e29b-41d4-a716-44665544200a", timestamp: "2025-02-18 15:25:39", srcIp: "94.102.61.88", dstIp: "10.0.0.20", protocol: "UDP", packetSize: 256, attackType: "scanning", severity: "high" },
        { uuid: "770e8400-e29b-41d4-a716-44665544200b", timestamp: "2025-02-18 15:31:58", srcIp: "185.130.5.253", dstIp: "10.0.0.14", protocol: "TCP", packetSize: 1500, attackType: "exploit", severity: "critical" },
      ];
  ...
  // Filter logic (search includes UUID, IPs, protocol, attack type, etc.)
  ...
  const handleViewLog = (log: AttackLog) => {
  ...
  const getAttackBadge = (attackType: string, severity: string) => {
    ...
    if (attackType === "malicious") {
      return <span className="inline-flex px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-700 text-white">Malicious</span>;
    }
    if (attackType === "exploit") {
      return <span className="inline-flex px-2.5 py-0.5 rounded-full text-xs font-medium bg-orange-100 text-orange-800">Exploit</span>;
    }
    if (attackType === "scanning") {
      return <span className="inline-flex px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">Scanning</span>;
    }
    return <span className="inline-flex px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">{attackType}</span>;
  };
            ...
            <div className="flex flex-col md:flex-row gap-4 items-start md:items-center">
              ...
              <div className="flex-1 w-full">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="Search by UUID, IP, protocol, attack type, size..."
                    value={searchTerm}
            ...
            <div className="bg-white rounded-lg shadow border border-gray-200 overflow-hidden">
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Attack Type</th>
                  ...
                  <tbody className="divide-y divide-gray-100">
                    {paginatedLogs.map((log) => (
                      <tr key={log.uuid} className="hover:bg-gray-50 transition">
                        ...
                        <td className="px-6 py-3">{getAttackBadge(log.attackType, log.severity)}</td>
                        <td className="px-6 py-3">
                          <span className={`inline-flex px-2.5 py-0.5 rounded-full text-xs font-medium ${
                            log.severity === "critical" ? "bg-red-100 text-red-800" : "bg-orange-100 text-orange-800"
                          }`}>
                        ...
                        <td className="px-6 py-3">
                          <button
                            ...
                            aria-label={`View details for attack log ${log.uuid}`}
                            title="View details"
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
              ...
              {paginatedLogs.length === 0 && (
                <div className="text-center py-12 text-gray-500">
                  No attack logs match your filters.
                </div>
              )}
