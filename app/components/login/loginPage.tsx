...
import { loginClient } from "../../api/client/auth";
            ...
            <div className="p-6 md:p-8">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between flex-wrap gap-3 mt-1">
                  <label className="flex items-center gap-2 cursor-pointer group">
                    <input
                      ...
                      className="w-4 h-4 rounded border-gray-300 text-emerald-600 focus:ring-emerald-500 focus:ring-offset-0 accent-emerald-600 transition"
                    />
                    <span className="text-sm font-medium text-gray-700 group-hover:text-emerald-700 transition">
                      Reconnect Me
                    </span>
                  </label>
                  <a
                    ...
                    className="text-sm font-medium text-emerald-600 hover:text-emerald-800 hover:underline transition-all duration-200"
                  >
                    Recovery Password
                  </a>
                </div>
              ...
              <div className="text-center mt-6">
                <p className="text-sm text-gray-600">
                  ...
                  <a href="/signup" className="font-semibold text-emerald-700 hover:text-emerald-900 hover:underline ml-1 transition">
                    Sign Up
                  </a>
                </p>
              </div>
